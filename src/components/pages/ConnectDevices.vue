      ...
      <v-card-text class="d-flex flex-column align-center">
        ...
        <div class="d-flex step-1 align-center flex-wrap">
          ...
          <div class="d-flex flex-column flex-grow-1 justify-space-between my-1 instructions-wrapper">
            ...
            <h1 v-if="isMonocularMode" class="my-4">4. Position the tripod and camera to capture the volume of interest. Keep the subject within five meters of the camera.</h1>
            ...
            <h1 v-if="isMonocularMode" class="my-4">
              5. Have the person practice the activity and verify their whole body is fully in frame and clearly visible to the camera—not cut off, and not hidden behind other objects (e.g. furniture or people)
            </h1>
